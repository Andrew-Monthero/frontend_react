    ...
    <div>
      <header className='flex-wrap flex items-center justify-between'>
        ...
        <a
          ...
          className='bg-gray-100 rounded-lg text-gray-500 font-bold py-3 px-4 whitespace-nowrap text-center hover:bg-pink-500 hover:text-pink-100 transition'
        >
          View Project
        </a>
      </header>
      ...
      />
      {/* content */}
      <div className='text-lg text-slate-50 mt-5'>
